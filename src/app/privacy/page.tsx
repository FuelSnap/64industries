    ...
    <div className="pt-32 pb-24 px-8 bg-white">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="prose prose-zinc max-w-none text-[15px] leading-relaxed space-y-6 text-zinc-500">
          ...
          <h2 className="font-display font-700 text-xl text-zinc-900 mt-8">Information We Collect</h2>
          <p>
          ...
          <h2 className="font-display font-700 text-xl text-zinc-900 mt-8">How We Use Your Information</h2>
          ...
          <h2 className="font-display font-700 text-xl text-zinc-900 mt-8">Data Sharing</h2>
          <p>
          ...
          <h2 className="font-display font-700 text-xl text-zinc-900 mt-8">Data Security</h2>
          <p>
            We take reasonable measures to protect the information you provide. However, no method
            of transmission over the internet is 100% secure, and we cannot guarantee absolute security.
          </p>

          <h2 className="font-display font-700 text-xl text-zinc-900 mt-8">Cookies</h2>
          <p>
          ...
          <h2 className="font-display font-700 text-xl text-zinc-900 mt-8">Your Rights</h2>
          <p>
