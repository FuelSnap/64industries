      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-3 text-zinc-400 text-sm">
              <span className="block">Product Launches</span>
              <span className="block">Social Media Management</span>
              <span className="block">Brand Deal Brokering</span>
              <span className="block">Growth Strategy</span>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-5">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-white transition-colors" aria-label="Instagram">
            ...
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-white transition-colors" aria-label="X">
