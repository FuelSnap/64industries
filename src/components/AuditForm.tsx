          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 px-4 py-3 text-white text-sm rounded-btn placeholder:text-zinc-600 focus:outline-none focus:border-brand-red transition-colors"
                />
              </div>
              <div>
                <label className="block font-mono text-[10px] text-zinc-500 uppercase tracking-widest mb-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  required
                  className="w-full bg-white/5 border border-white/10 px-4 py-3 text-white text-sm rounded-btn focus:outline-none focus:border-brand-red transition-colors appearance-none"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 px-4 py-3 text-white text-sm rounded-btn placeholder:text-zinc-600 focus:outline-none focus:border-brand-red transition-colors resize-none"
              />
            </div>

            <button
              type="submit"
              className="w-full bg-brand-red text-white font-display font-600 text-[15px] tracking-wide py-4 rounded-btn hover:bg-brand-red-hover transition-colors"
            >
              Get My Free Audit
            </button>
          </form>
